...
const styles = StyleSheet.create({
  ...
  dot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#F5A623' },
  liveText: { fontSize: 11, fontWeight: '700', color: '#F5A623', letterSpacing: 1 },
  link: { fontSize: 12, color: '#F5A623', fontWeight: '500' },
  boxName: { fontSize: 16, fontWeight: '700', color: '#fff', marginBottom: 4 },
  time: { fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 12 },
  ...
  remainingValue: { fontSize: 24, fontWeight: '700', color: '#F5A623', fontVariant: ['tabular-nums'] },
